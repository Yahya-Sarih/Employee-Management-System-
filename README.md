...
##  Overview  
The Employee Management System (EMS) is a small web application developed for **Alton**, which is a consulting firm in management and information systems, using **Django**.  
